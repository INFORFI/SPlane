...
import { Eye, ChevronDown, Search, Calendar, FileText, Github } from 'lucide-react';
      ...
      news: [
        {
          name: 'patchnote',
          description:
            '👷‍♂️ Ajout de la fonctionnalité de patchnote automatique depuis github actions',
          pr_number: '43',
        },
      ],
      corrections: [],
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <motion.div variants={itemVariants}>
            ...
            <p className="text-zinc-400">
              Administrez les notes de mise à jour pour tenir vos utilisateurs informés
            </p>
          </motion.div>
          ...
          {filteredPatchnotes.length > 0 ? (
                ...
                >
                  ...
                  <div className="md:col-span-1 flex md:block items-center justify-between">
                    <div className="flex items-center gap-2 md:gap-0">
                      ...
                      <div
                        className={`px-2 py-1 rounded-full text-xs font-medium inline-flex items-center ${patchnote.published ? 'bg-emerald-500/10 text-emerald-400' : 'bg-amber-500/10 text-amber-400'}`}
                      >
                        <span
                          className={`h-2 w-2 rounded-full ${patchnote.published ? 'bg-emerald-500' : 'bg-amber-500'} mr-1.5`}
                        ></span>
                  ...
                  <div className="md:col-span-3 flex items-center justify-end gap-2 mt-4 md:mt-0">
                    <button className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm rounded-lg transition-colors cursor-pointer ml-2">
                      Détails
                    </button>
                  </div>
                </motion.div>
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-zinc-500 mt-4 text-xs max-w-md">
                Les patchnotes sont créés automatiquement à partir des PR fusionnées via GitHub
                Actions
              </p>
            </div>
          )}
